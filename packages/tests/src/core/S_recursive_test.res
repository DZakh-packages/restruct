...
test(
  ...
  t => {
    ...
    t->U.assertCompiledCode(
      ~schema=nodeSchema,
      ~op=#Parse,
      `i=>{if(!i||i.constructor!==Object){e[4](i)}let r3=i=>{let v0=i["Id"],v1=i["Children"],v6=[];if(typeof v0!=="string"){e[0](v0)}if(!Array.isArray(v1)){e[1](v1)}for(let v2=0;v2<v1.length;++v2){let v4=v1[v2],v5;try{if(!v4||v4.constructor!==Object){e[2](v4)}v5=r3(v4)}catch(v3){if(v3&&v3.s===s){v3.path="[\\"Children\\"]"+\'["\'+v2+\'"]\'+v3.path}throw v3}v6.push(v5)}return e[3]({"id":v0,"children":v6,})};return r3(i)}`,
    )
    t->Assert.deepEqual(
      {
        "Id": "1",
    ...
    t->U.assertCompiledCode(
      ~schema=nodeSchema,
      ~op=#ReverseConvert,
      `i=>{let r3=i=>{let v0=e[0](i),v1=v0["children"],v5=[];for(let v2=0;v2<v1.length;++v2){let v4;try{v4=r3(v1[v2])}catch(v3){if(v3&&v3.s===s){v3.path="[\\"children\\"]"+\'["\'+v2+\'"]\'+v3.path}throw v3}v5.push(v4)}return {"Id":v0["id"],"Children":v5,}};return r3(i)}`,
    )
    t->Assert.deepEqual(
      {
        id: "node_1",
...
test("Shallowly transforms object when added transform to the S.recursive result", t => {
  ...
  t->U.assertCompiledCode(
    ~schema=nodeSchema,
    ~op=#Parse,
    `i=>{if(!i||i.constructor!==Object){e[4](i)}let r5=i=>{let v0=i["Id"],v1=i["Children"],v6=[];if(typeof v0!=="string"){e[0](v0)}if(!Array.isArray(v1)){e[1](v1)}for(let v2=0;v2<v1.length;++v2){let v4=v1[v2],v5;try{if(!v4||v4.constructor!==Object){e[2](v4)}v5=r5(v4)}catch(v3){if(v3&&v3.s===s){v3.path="[\\"Children\\"]"+\'["\'+v2+\'"]\'+v3.path}throw v3}v6.push(v5)}return {"id":v0,"children":v6,}};return e[3](r5(i))}`,
  )
  t->U.assertCompiledCode(
    ~schema=nodeSchema,
    ~op=#ReverseConvert,
    `i=>{let v0=e[0](i);let r5=v0=>{let v1=v0["children"],v5=[];for(let v2=0;v2<v1.length;++v2){let v4;try{v4=r5(v1[v2])}catch(v3){if(v3&&v3.s===s){v3.path="[\\"children\\"]"+\'["\'+v2+\'"]\'+v3.path}throw v3}v5.push(v4)}return {"Id":v0["id"],"Children":v5,}};return r5(v0)}`,
  )
})
